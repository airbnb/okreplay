...
/**
 * This class is the main interface to Walkman. It controls the Walkman lifecycle, inserting and
...
public class Recorder {
  ...
  public Recorder(Configuration configuration, WalkmanInterceptor interceptor) {

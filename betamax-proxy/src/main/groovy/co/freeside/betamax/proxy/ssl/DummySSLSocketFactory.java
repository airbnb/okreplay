...
public class DummySSLSocketFactory extends SSLSocketFactory {
    ...
    public static DummySSLSocketFactory getInstance() throws GeneralSecurityException, IOException {
        KeyStore trustStore = KeyStore.getInstance(KeyStore.getDefaultType());
        trustStore.load(null, null);
        return new DummySSLSocketFactory(trustStore);
    }

    public DummySSLSocketFactory(KeyStore trustStore) throws GeneralSecurityException {
        super(trustStore);

...
class ProxyHandler extends AbstractHandler {
	...
	private void proceedRequest(co.freeside.betamax.proxy.Request request, Response response) {
	...
	private HttpUriRequest createProxyRequest(co.freeside.betamax.proxy.Request request) {
		def proxyRequest

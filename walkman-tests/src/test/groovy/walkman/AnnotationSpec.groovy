...
//import walkman.android.RecorderRule
...
//  }
//
//  @Walkman(tape = 'annotation_spec', mode = WRITE_ONLY, match = [MatchRules.body])
...
//  }
//
//  @Walkman(tape = 'annotation_spec', mode = READ_WRITE)
...
//    connection.getHeaderField(X_WALKMAN) == 'REC'
//  }
//
//  @Walkman(tape = 'annotation_spec', mode = READ_WRITE)

...
import static walkman.TapeMode.READ_SEQUENTIAL
...
class SequentialTapeSpec extends Specification {
  ...
  static
  final TAPE_ROOT = new File(SequentialTapeSpec.getResource("/walkman/tapes").toURI())
  ...
  @Walkman(tape = "sequential tape", mode = READ_SEQUENTIAL)
  ...
  @Walkman(tape = "rest conversation tape", mode = READ_SEQUENTIAL)
